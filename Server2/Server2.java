...
static Map<String, String> StoreTable = new ConcurrentHashMap<String, String>();
	...
	try{
		serversock = new ServerSocket(5052);
System.out.println("Connection Socket Created : Port number 5052: Server2");
		try{
		while(true){
		System.out.println("Waiting for Connection on port 5052");
		new Server2 (serversock.accept());
		}
		}
		catch (IOException e) 
            	{ 
	...
	private Server2 (Socket clientsock){
		...
		BufferedReader in = new BufferedReader(new InputStreamReader( clientSocket.getInputStream()));
			...
			while((inputLine = in.readLine()) != null)
			{
				...
				System.out.println(HashValue);
		        	...
		        	System.out.println("Entry added at Server2");
				out.println("Entry added at Server2");
		        }
				...
				System.out.println("Value is:"+Value);
		        	out.println("Value is:"+Value + "at Server2");
		        }
				...
				System.out.println("Entry removed");
		        	out.println("Entry removed from Server 2");
		        }
