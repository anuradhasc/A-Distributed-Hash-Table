...
System.out.println("Connection Socket Created : Port number 5051: Server1");
		try{
		while(true){
		System.out.println("Waiting for Connection on port 5051");
		new Server1 (serversock.accept());
		}
		}
		catch (IOException e) 
            	{ 
	...
	private Server1 (Socket clientsock){
...
BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
		...
		out.println("Entry added at Server1");
		}
		...
		out.println("Value is:"+Value +"At server1");
		}
		...
		out.println("Entry removed from Server1");
		}
		}	
		in.close();
		out.close();
