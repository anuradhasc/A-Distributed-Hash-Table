...
public class Server3 extends Thread {
	...
	FileInputStream fstream = new FileInputStream ("config.properties");
		...
		try{
			serversock = new ServerSocket(5053);
System.out.println("Connection Socket Created : Port number 5053: Server3");
			try{
			while(true){
		System.out.println("Waiting for Connection on port 5053");
			new Server3 (serversock.accept());
			}
			}
			catch (IOException e) 
                      { 
	...
	private Server3 (Socket clientsock){
	...
	BufferedReader in = new BufferedReader(new InputStreamReader( clientSocket.getInputStream()));
			...
			while((inputLine = in.readLine()) != null)
			{
				...
				out.println("Entry added at Server3");
		        }
				...
				System.out.println("Value is:"+Value);
		        	out.println("Value is:"+Value +"at Server3");
		        }
				...
				System.out.println("Entry removed");
		        	out.println("Entry removed from Server3");
		        }
