...
System.out.println("Connection Socket Created : Port number 5056: Server6");
	try{
	while(true){
	System.out.println("Waiting for Connection on port 5056");
	new Server6 (serversock.accept());
	}
	}
	catch (IOException e) 
        { 
        ...
        { 
         System.err.println("Could not listen on port: 5056."); 
         System.exit(1); 
        } 
	finally
        {
         try {
             ...
             { 
              System.err.println("Could not close port: 5056."); 
              System.exit(1); 
             } 
        }
	}
		
	private Server6 (Socket clientsock){
	...
	BufferedReader in = new BufferedReader(new InputStreamReader( clientSocket.getInputStream()));
			...
			while((inputLine = in.readLine()) != null)
			{
				...
				out.println("Entry added at Server 6");
		        }
				...
				System.out.println("Value is:"+Value);
		        	out.println("Value is:"+Value +"Server6");
		        }
				...
				System.out.println("Entry removed");
		        	out.println("Entry removed from Server6");
		        }
